...
#define IO_GET_DRIVER_STATUS			CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4002, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)

//Cheat Memory access
#define IO_READ_PROCESS_MEMORY			CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4003, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_WRITE_PROCESS_MEMORY			CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4004, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_READ_PROCESS_MEMORY_32		CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4005, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_WRITE_PROCESS_MEMORY_32		CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4006, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)

//Injection Functions (for internal cheats)
#define IO_INJECT_DLL					CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4007, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)

//CS GO ONLY Methods
#define IO_GET_ALL_MODULES				CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4008, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
