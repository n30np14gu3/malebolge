...
//Cheat Memory access
#define IO_ATTACH_TO_PROCESS CTL_CODE(FILE_DEVICE_UNKNOWN, 0x3000, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_READ_PROCESS_MEMORY CTL_CODE(FILE_DEVICE_UNKNOWN, 0x3001, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_WRITE_PROCESS_MEMORY CTL_CODE(FILE_DEVICE_UNKNOWN, 032002, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_DETACH_TO_PROCESS CTL_CODE(FILE_DEVICE_UNKNOWN, 032003, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
